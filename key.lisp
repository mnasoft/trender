...
(defvar key-list-home-win)

(defvar key-code-hash)
(defvar key-string-hash)

(defvar key-list)
(setf key-list-kbd-hp  '(
			 ("Esc" 9)
      ...
      key-list-home-win '(("Esc" 9)
			  ...
			  ("a" 38) ("s" 39) ("d" 40) ("f" 41) ("g" 42) ("h" 43) ("j" 44) ("k" 45) ("l" 46) (";" 47) ("'" 48) ("\\" 51)
			  ("z" 52) ("x" 53) ("c" 54) ("v" 55) ("b" 56) ("n" 57) ("m" 58) ("," 59) ("." 60) ("/" 61)
			  ("Insert" 106) ("Delete" 107)
			  ("Home" 97) ("End" 103)
			  ("PgUp" 99) ("PgDn" 105)
			  ("Up" 98) ("Down" 104)
			  ("Left" 100) ("Right" 102)
			  ("NumLock" 77) ("Num-/" 112) ("Num-*" 63) ("Num--" 82) ("Num-+" 86) ("Num-Enter" 108)
			  ("Num-0" 90) ("Num-." 91)
			  ("Num-1" 87) ("Num-2" 88) ("Num-3" 89)
			  ("Num-4" 83) ("Num-5" 84) ("Num-6" 85)
			  ("Num-7" 79) ("Num-8" 80) ("Num-9" 81)
			  ("Backspace" 22) ("Enter" 36)
			  ("Tab" 23) ("CapsLock" 66)
			  ("L-Shift" 50) ("R-Shift" 62)
			  ("L-Ctrl" 37) ("R-Ctrl" 109)
			  ("L-Alt" 64) ("R-Alt" 113)
			  ("Space" 65) ("Menu" 117))
      key-list (cond
		 ((equal (machine-instance) "nick-00")  key-list-home)
		 ((equal (machine-instance) "NICK-00")  key-list-home-win)
		 (T key-list-kbd-hp))
      key-code-hash (make-hash-table :size 256)
      key-string-hash (make-hash-table :size 256 :test #'equal)
      )
